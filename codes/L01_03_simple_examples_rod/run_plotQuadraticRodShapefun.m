...
hold on;
plot(x,N3,'k-')
legend('N_1','N_2','N_3','Location','North')
xlabel('Longitudinal coordinate x [m]')
ylabel('Shapefunction')
print("Shapef3NodeRod",'-depsc2');
print("Shapef3NodeRod",'-dtiff');
...
hold on;
plot(x,uhdef,'b-')
legend('Displacement at u=[0,0]','Displacement at u=[0,0,0.1]','Location','North')
xlabel('Longitudinal coordinate x [m]')
