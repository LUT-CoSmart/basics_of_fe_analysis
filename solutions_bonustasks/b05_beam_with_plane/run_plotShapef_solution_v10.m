...
vvGivenDispl=[0, 0.01, 0.01, 0]';             % TIP: Change line so that you give displacement on nodes 2 and 3

NvecGivenDispl=ShapefunctionsQ4(Lx,Ly,0,0);
uhGivenDispl=NvecGivenDispl*uuGivenDispl     % TIP: Just take this results to Moodle
vhGivenDispl=NvecGivenDispl*vvGivenDispl     % TIP: Just take this results to Moodle

uu=zeros(8,1);
uu(1:2:end)=uuGivenDispl;
uu(2:2:end)=vvGivenDispl;

Uint=UQ4(E,nu,Lx,Ly,Lz,uu)                      % TIP: give nodal displacements based on the assigment and input this in Moodle
